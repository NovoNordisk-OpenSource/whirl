...
The main function in the whirl package is
[`run()`](https://novonordisk-opensource.github.io/whirl/reference/run.md)
which takes an `input` argument that defines the scripts to be executed.
...
[`run()`](https://novonordisk-opensource.github.io/whirl/reference/run.md)
can use up to two simultaneous workers to execute the scripts, meaning
...
[`run()`](https://novonordisk-opensource.github.io/whirl/reference/run.md)
also supports running scripts in several sequential steps. This setup is
very useful when your projects have several steps that depends on each
others output, and thereby need to be executed in a specific order. The
best way to implement this in your project is use a configuration file
for whirl. The configuration file is a `yaml` file that specifies each
steps:
...
- [`run()`](https://novonordisk-opensource.github.io/whirl/reference/run.md):
  For further information on how to call it.
- [`vignette("whirl")`](https://novonordisk-opensource.github.io/whirl/articles/whirl.md):
  For a more in depth explanation, and more advanced usage.
- [`vignette("articles/example")`](https://novonordisk-opensource.github.io/whirl/articles/example.md):
  With a simple example, including the created log.
