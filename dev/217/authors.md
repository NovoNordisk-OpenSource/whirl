...
- **Michael Svingel**. Author.

- **Skander Mulder**. Author.

- **Oliver Lundsgaard**. Author.
...
Source:
[`DESCRIPTION`](https://github.com/NovoNordisk-OpenSource/whirl/blob/feat/release-v0.3.2/DESCRIPTION)

Thomsen A, Gakava L, Girard C, Troejelsgaard K, Larsen S, Obucina V,
Svingel M, Mulder S, Lundsgaard O (2025). *whirl: Log Execution of
Scripts*. R package version 0.3.2,
