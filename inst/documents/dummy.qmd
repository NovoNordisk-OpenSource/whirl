...
#| include: true
tmpdir = "inst/documents"
print(tmpdir)
print(globals())
import sys
sys.path.append(tmpdir)
from python_module2 import get_package_status
get_package_status(tmpdir+"/"+'old_status.json')
```
...
#| eval: !expr base::grepl("\\.py$", params$script)
#| include: false
get_package_status('new_status.json')
```
...
#| include: false
  saveRDS(
    object =system('python3 -m pip list -v', intern = TRUE),
    file = file.path(params$tmpdir, "pip_list.rds")
  )
