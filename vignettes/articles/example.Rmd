...
#   file.copy(".Renviron", to = tmp)
# }
if (file.exists("../../.Renviron")) {
  cli::cli_alert("Copying",  normalizePath("../../.Renviron"), "to", tmp, "\n")
  file.copy(normalizePath("../../.Renviron"), to = file.path(tmp, ".Renviron"))
}
