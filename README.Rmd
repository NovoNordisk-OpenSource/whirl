...
1. Creates a log in the same directory as the script with the names `{script_name}_log.html`.
1. Creates a summary log with the overall status of each script. Default path is `summary.html`.
